        ...
        <div id="main-header" class="py-2 bg-light text-dark" >
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-4">
                        <h1>
                            <i class="fas fa-user-cog"></i>Control Sedes
                        </h1>
                    </div>
                    <div  class="col-4"></div>
                </div>
                ...
                <div class="container">
                    <div class="row ">
                        <div class="col-md-12 col-sm-12 col-12 upbar">
                            ...
                            <button type="button" class="btn btn-secondary btn-agregar"  data-bs-toggle="modal" data-bs-target="#addModal">Agregar Sede</button>
                            <hr class="lineas-separacion">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="modal-body">
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nombreAgencia" name="nombreAgencia" required>
                                    </div>
                                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 col-xl-12">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <c:forEach items="${data}" var="sede">
                                            <tr>
                                                <td>${sede.id}</td>
                                                <td>${sede.nombreAgencia}</td>
                                                <td>${sede.nit}</td>
                                                <td>${sede.direccion}</td>                                     
                                                <td>${sede.rutaImagen}</td>
                                                <td>
                                                    <a class="btn btn-warning" href="${pageContext.request.contextPath}/ServletSede?accion=editar&id=${sede.id}">
                                                        <i class="fa fa-edit"></i> Editar
                                                    </a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-secondary" href="${pageContext.request.contextPath}/ServletSede?accion=eliminar&id=${sede.id}">
