<%-- 
    Document   : editar-roles
    Created on : 16/09/2022, 18:21:37
                                                ...
                                                <div class="modal-body">
                                                    <form>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="idRol" name="idRol" value="${rol.id}" readonly="true" disable>
                                                        </div>
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4 text-center">
                                                                <a class="btn btn-danger" href="${pageContext.request.contextPath}/ServletRol?accion=eliminar&id=${rol.id}">
