        ...
        <div id="main-header" class="py-2 bg-light text-dark" >
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-4">
                        <h1>
                            <i class="fas fa-user-cog"></i>Control Roles
                        </h1>
                    </div>
                    <div  class="col-4"></div>
                </div>
                ...
                <div class="container">
                    <div class="row ">
                        <div class="col-md-12 col-sm-12 col-12 upbar">
                            ...
                            <button type="button" class="btn btn-secondary btn-agregar"  data-bs-toggle="modal" data-bs-target="#addModal">Agregar Rol</button>
                            <hr class="lineas-separacion">
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        <c:forEach items="${data}" var="rol">
                                            <tr>
                                                ...
                                                <td>${rol.nombre}</td>
                                                <td>
                                                    <a class="btn btn-warning" href="${pageContext.request.contextPath}/ServletRol?accion=editar&id=${rol.id}">
                                                        <i class="fa fa-edit"></i> Editar
                                                    </a>                                                
                                                </td>
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/ServletRol?accion=eliminar&id=${rol.id}" class="btn btn-secondary">
