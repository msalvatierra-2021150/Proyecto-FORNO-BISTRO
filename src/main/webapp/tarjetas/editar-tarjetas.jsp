                    ...
                    <div class="col-10 col-md-10">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <form method="POST" action="${pageContext.request.contextPath}/ServletTarjeta">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label for="numero_de_tarjeta" class="col-form-label">Numero De Tarjeta</label>
                                            <input type="text" class="form-control" id="numero_de_tarjeta"  name="numero_de_tarjeta" value="${tarjeta.getNumeroDeTarjeta()}" readonly="readonly" required>
                                        </div>                        
                                        <div class="form-group">
                                            <label for="nombre_en_tarjeta" class="col-form-label">Nombre de la Tarjeta</label>
                                            <input type="text" class="form-control" id="nombre_en_tarjeta" name="nombre_en_tarjeta" value="${tarjeta.getNombreDeTarjeta()}" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="fecha_vencimiento" class="col-form-label">Fecha de vencimiento</label>
                                            <input type="text" class="form-control" id="fecha_vencimiento" name="fecha_vencimiento" value="${tarjeta.getFechaVencimiento()}" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="tipo_de_tarjeta" class="col-form-label">Tipo de tarjeta</label>
                                            <input type="text" class="form-control" id="tipo_de_tarjeta" name="tipo_de_tarjeta" value="${tarjeta.getTipoDeTarjeta()}" required>
                                        </div>                   
                                    ...
                                    <div class="mb-3 mt-3">
                                        <div class="container">
                                            ...
                                            <div class="row">
                                                <div class="col-1">  </div>
                                                <div class="col-3">
                                                    <a class="btn btn-secondary" href="${pageContext.request.contextPath}/ServletTarjeta?accion=listar">
                                                        <i class="fa fa-arrow-left"></i> Cancelar/Regresar
                                                    </a> 
                                                </div>
                                                <div class="col-1">  </div>
                                                <div class="col-3">
                                                    <button type="submit" href="${pageContext.request.contextPath}/ServletTarjeta?accion=listar" class="btn btn-success">
