...
<html lang="es">
    ...
    <header>
        ...
        <div id="main-header" class="py-2 bg-light text-dark" >
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-4">
                        <h1>
                            <i class="fas fa-user-cog"></i>Control Platillos
                        </h1>
                    </div>
                    <div  class="col-4"></div>
                </div>
        ...
        <div class="center">   
            <img src="../assets/images/banners/platillos.png" class="img-fluid" alt="...">
        </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-xl-12">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                    <c:forEach items="${arraylistPlatillo}" var="platillos">
                                        <tr>

                                    <div class="card mb-3 w-100">
                                        <img class="card-img-top" src="../assets/images/platillos${platillos.rutaImagen}" alt="Card image cap">
                                        <div class="card-body">
                                            <h5 class="card-title text-center">${platillos.nombre}</h5>
                                            <h5 class="card-title text-center">${platillos.descripcion}</h5>
                                            <p class="card-text text-center">Q ${platillos.precio}</p>
                                            
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-2 text-center">            
                                                    <a href="${pageContext.request.contextPath}/ServletPlatillo?accion=eliminar&id=${platillos.id}" class="btn btn-secondary">
                                                    ...
                                                    <div class="col-2 text-center">            
                                                            <a class="btn btn-warning" href="${pageContext.request.contextPath}/ServletPlatillo?accion=editar&id=${platillos.id}">
